...
const Hero: React.FC = () => {
  return (
    <section className="relative min-h-screen flex flex-col justify-center items-start bg-living-slate">
      ...
      {/* Content */}
      <div className="container mx-auto px-8 md:px-4 relative z-10 pt-28 md:pt-32 pb-12 md:pb-16">
